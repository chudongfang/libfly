...
int main()
{
	...
	for(int i=0;i<number;i++)
	{
		...
		tsk->fd = -1;
        RoutineArr.push_back(new Routine(get_curr_thread_env(),NULL,readwrite_routine,tsk) );	
    ...
    Routine*  accepter = (new Routine(get_curr_thread_env(),NULL,accept_routine,NULL) );	
    accepter->resume();
